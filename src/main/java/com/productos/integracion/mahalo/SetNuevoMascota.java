 ...
 *         &lt;element name="DetalleMascota" type="{http://tempuri.org/}ArrayOfMascota" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SetNuevoMascota")
public class SetNuevoMascota {
    ...
    protected ArrayOfMascota detalleMascota;
     ...
     *     
     */
    public ArrayOfMascota getDetalleMascota() {
     ...
     *     
     */
    public void setDetalleMascota(ArrayOfMascota value) {

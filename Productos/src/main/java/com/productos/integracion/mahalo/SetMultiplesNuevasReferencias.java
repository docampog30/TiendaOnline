 ...
 *         &lt;element name="sw_generaReferencias" type="{http://tempuri.org/}Sw_ValidaRefProveedor" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "SetMultiplesNuevasReferencias")
public class SetMultiplesNuevasReferencias {
    ...
    @XmlElement(name = "sw_generaReferencias")
    protected SwValidaRefProveedor swGeneraReferencias;
    ...
    /**
     * Obtiene el valor de la propiedad swGeneraReferencias.
     * 
     * @return
     *     possible object is
     *     {@link SwValidaRefProveedor }
     *     
     */
    public SwValidaRefProveedor getSwGeneraReferencias() {
        return swGeneraReferencias;
    }

    /**
     * Define el valor de la propiedad swGeneraReferencias.
     * 
     * @param value
     *     allowed object is
     *     {@link SwValidaRefProveedor }
     *     
     */
    public void setSwGeneraReferencias(SwValidaRefProveedor value) {
        this.swGeneraReferencias = value;
    }
